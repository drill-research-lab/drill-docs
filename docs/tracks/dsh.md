...
- Fork：[drill-research-lab/deepseek-harness](https://github.com/drill-research-lab/deepseek-harness)
- 進行中：用戶隔離 + 驗證（阿柏；安全層必須人工）
- 自進化 spec 輸入格式：待定（decisions.md 待釐清 #3）

## seam ↔ Drill 功能對應（待填）

| Drill 功能 | DSH seam / plugin | 詳情 |
|---|---|---|
| （待填） | | |
